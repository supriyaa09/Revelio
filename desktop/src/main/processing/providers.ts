 ...
 *
 * Main-process only, for the same reason as analyze.ts: it reads credentials.
 */
if ('window' in globalThis) {
  throw new Error(
    'processing/providers.ts is main-process only. Do not import it from the renderer.',
  );
}
